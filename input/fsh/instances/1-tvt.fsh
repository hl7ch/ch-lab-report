...
* extension[DiagnosticReportObservationR5].url = $diagnostic-report-observation-r5
* extension[DiagnosticReportObservationR5].valueReference = Reference(Observation/8903c6a4-6547-437c-8f47-b68cfe959288)
