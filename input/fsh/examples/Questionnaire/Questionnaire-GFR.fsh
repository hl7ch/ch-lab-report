...
* extension[=].valueExpression.expression = "%resource.repeat(item).where(linkId='3.3.1').item.answer.value"
* extension[+].url = "http://hl7.org/fhir/StructureDefinition/variable"
* extension[=].valueExpression.name = "height"
* extension[=].valueExpression.language = #text/fhirpath
* extension[=].valueExpression.expression = "%resource.repeat(item).where(linkId='3.3.2').item.answer.value*0.0254"
...
* extension[=].extension[=].valueCoding = $launchContext#patient "Patient"
...
* item[=].item[=].answerOption[0].valueCoding = $loinc#LA28397-0 "Often true"
* item[=].item[=].answerOption[+].valueCoding = $loinc#LA6729-3 "Sometimes true"
* item[=].item[=].answerOption[+].valueCoding = $loinc#LA28398-8 "Never true"
* item[=].item[=].answerOption[+].valueCoding = $loinc#LA15775-2 "Don't know/refused"
...
* item[=].item[=].extension[=].extension[=].valueCoding = $conditions#3
...
* item[=].item[=].extension[=].extension[=].valueCoding = $conditions#4
* item[=].item[=].extension[=].extension[+].url = "expression"
* item[=].item[=].extension[=].extension[=].valueExpression.language = #text/fhirpath
...
* item[=].item[=].repeats = true
* item[=].item[=].answerOption[0].valueCoding = $procedures#U1 "Heart attack"
* item[=].item[=].answerOption[+].valueCoding = $procedures#U2 "Heart surgery"
* item[=].item[=].answerOption[+].valueCoding = $procedures#U3 "Cardiac catheterization"
* item[=].item[=].answerOption[+].valueCoding = $procedures#U4 "Coronary angioplasty (PTCA)"
* item[=].item[=].answerOption[+].valueCoding = $procedures#U5 "Cardiac pacemaker"
* item[=].item[+].extension.url = "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-minOccurs"
* item[=].item[=].extension.valueUnsignedInt = 2
...
* item[=].item[=].answerOption[+].valueCoding = $procedures#U4 "Coronary angioplasty (PTCA)"
* item[=].item[=].answerOption[+].valueCoding = $procedures#U5 "Cardiac pacemaker"
* item[=].item[+].extension.url = "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-maxOccurs"
* item[=].item[=].extension.valueUnsignedInt = 3
...
* item[=].item[=].type = #choice
* item[=].item[=].repeats = true
* item[=].item[=].answerOption[0].valueCoding = $treatments#noTreatment "NoTreatment"
* item[=].item[=].answerOption[+].valueCoding = $treatments#aspirin "Aspirin"
* item[=].item[=].answerOption[+].valueCoding = $treatments#otherMeds "Other medicines, tablets, or pills"
* item[=].item[=].answerOption[+].valueCoding = $treatments#diet "Diet"
* item[=].item[=].answerOption[+].valueCoding = $treatments#exercise "Exercise"
...
* item[=].item[=].answerOption[=].valueCoding = $treatments#none "None of the above"
* item[=].item[+].extension[0].url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unitOption"
* item[=].item[=].extension[=].valueCoding = $unitsofmeasure#mL "mL"
* item[=].item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unitOption"
* item[=].item[=].extension[=].valueCoding = $unitsofmeasure#L "L"
* item[=].item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unitOption"
* item[=].item[=].extension[=].valueCoding = $unitsofmeasure#g "g"
* item[=].item[=].extension[+].url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unitOption"
* item[=].item[=].extension[=].valueCoding = $unitsofmeasure#mg "mg"
...
* item[=].item[=].item[=].extension.valueCoding = $unitsofmeasure#kg
...
* item[=].item[=].item[=].extension.valueCoding = $unitsofmeasure#[in_i]
...
* item[=].item[=].item[=].text = "Your Body Mass Index (BMI)"
* item[=].item[=].item[=].type = #decimal
* item[=].item[=].item[=].readOnly = true
...
* item[=].item[=].initial.valueCoding = $v3-MaritalStatus#D "Divorced"
...
* item[=].item[=].item[=].enableWhen.answerCoding = $administrative-gender#female
...
* item[=].item[=].item[=].enableWhen[=].operator = #=
* item[=].item[=].item[=].enableWhen[=].answerCoding = $v2-0136#Y
...
* item[=].item[=].extension[=].valueExpression.name = "homeAddress"
* item[=].item[=].extension[=].valueExpression.language = #text/fhirpath
* item[=].item[=].extension[=].valueExpression.expression = "%patient.address.where(use='home').first()"
...
* item[=].item[=].item[=].extension.valueExpression.language = #text/fhirpath
* item[=].item[=].item[=].extension.valueExpression.expression = "%homeAddress.line.first()"
...
* item[=].item[=].item[=].extension.valueExpression.language = #text/fhirpath
* item[=].item[=].item[=].extension.valueExpression.expression = "%homeAddress.city"
...
* item[=].item[=].item[=].extension.valueExpression.language = #text/fhirpath
* item[=].item[=].item[=].extension.valueExpression.expression = "%homeAddress.state"
...
* item[=].item[=].item[=].type = #choice
* item[=].item[=].item[=].answerOption[0].valueCoding = $provinces#Alberta "Alberta"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#BritishColumbia "British Columbia"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#Manitoba "Manitoba"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#NewBrunswick "New Brunswick"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#NewfoundlandAndLabrador "Newfoundland and Labrador"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#NovaScotia "Nova Scotia"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#Ontario "Ontario"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#PrinceEdwardIsland "Prince Edward Island"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#Quebec "Quebec"
* item[=].item[=].item[=].answerOption[+].valueCoding = $provinces#Saskatchewan "Saskatchewan"
* item[=].item[=].item[+].extension.url = "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-initialExpression"
* item[=].item[=].item[=].extension.valueExpression.description = "Postal Code"
* item[=].item[=].item[=].extension.valueExpression.language = #text/fhirpath
* item[=].item[=].item[=].extension.valueExpression.expression = "%homeAddress.postalCode"
