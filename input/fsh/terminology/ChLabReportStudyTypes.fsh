...
* $loinc#18768-2 "Cell counts+Differential studies (set)" // Hemogramme
* $loinc#18719-5 "Chemistry studies (set)"
* $loinc#26437-4 "Chemistry challenge studies (set)"
* $loinc#18720-3 "Coagulation studies (set)"
* $loinc#26438-2 "Cytology studies (set)"   // actually out of scope
...
* $loinc#26435-8 "Molecular pathology studies (set)"  // actually out of scope
* $loinc#18727-8 "Serology studies (set)"
* $loinc#56874-1 "Serology and blood bank studies (set)"
* $loinc#26439-0 "Surgical pathology studies (set)" // actually out of scope
